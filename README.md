...
Здесь представлены мои основные проекты, созданные во время учёбы на ФПМИ и на учебной программе Tinkoff Generation (Machine Learning), а также некоторые свободные проекты. Здесь представлены проекты, которые были созданы на время дедлайна по отправке анкеты (21.03.23), но к моменту возможной стажировки в этом списке проектов появятся новые.
